...
INSERT INTO `casbin_rule` VALUES (443,'p','1','/api/create','POST','','',''),(445,'p','1','/api/delete','POST','','',''),(448,'p','1','/api/deleteByIds','POST','','',''),(447,'p','1','/api/getElTree','POST','','',''),(444,'p','1','/api/list','POST','','',''),(446,'p','1','/api/update','POST','','',''),(467,'p','1','/captcha','POST','','',''),(430,'p','1','/casbin/update','POST','','',''),(454,'p','1','/cron/create','POST','','',''),(455,'p','1','/cron/delete','POST','','',''),(453,'p','1','/cron/list','POST','','',''),(457,'p','1','/cron/switchOpen','POST','','',''),(456,'p','1','/cron/update','POST','','',''),(459,'p','1','/dict/create','POST','','',''),(461,'p','1','/dict/delete','POST','','',''),(458,'p','1','/dict/list','GET','','',''),(460,'p','1','/dict/update','POST','','',''),(463,'p','1','/dictDetail/create','POST','','',''),(465,'p','1','/dictDetail/delete','POST','','',''),(466,'p','1','/dictDetail/flat','POST','','',''),(462,'p','1','/dictDetail/list','POST','','',''),(464,'p','1','/dictDetail/update','POST','','',''),(452,'p','1','/file/delete','GET','','',''),(451,'p','1','/file/download','GET','','',''),(450,'p','1','/file/list','POST','','',''),(449,'p','1','/file/upload','POST','','',''),(468,'p','1','/login','POST','','',''),(469,'p','1','/logout','POST','','',''),(471,'p','1','/menu/create','POST','','',''),(473,'p','1','/menu/delete','POST','','',''),(474,'p','1','/menu/getElTreeMenus','POST','','',''),(470,'p','1','/menu/list','GET','','',''),(472,'p','1','/menu/update','POST','','',''),(476,'p','1','/opl/delete','POST','','',''),(477,'p','1','/opl/deleteByIds','POST','','',''),(475,'p','1','/opl/list','POST','','',''),(439,'p','1','/role/create','POST','','',''),(440,'p','1','/role/delete','POST','','',''),(438,'p','1','/role/list','POST','','',''),(441,'p','1','/role/update','POST','','',''),(442,'p','1','/role/updateRoleMenu','POST','','',''),(434,'p','1','/user/create','POST','','',''),(433,'p','1','/user/delete','POST','','',''),(431,'p','1','/user/getUserInfo','GET','','',''),(432,'p','1','/user/list','POST','','',''),(436,'p','1','/user/modifyPasswd','POST','','',''),(437,'p','1','/user/switchActive','POST','','',''),(435,'p','1','/user/update','POST','','','');
...
CREATE TABLE `sys_management_dict` (
  ...
  `createdAt` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uni_sys_management_dict_ch_name` (`ch_name`),
...
INSERT INTO `sys_management_dict` VALUES (1,'2025-09-12 16:20:56','2025-09-12 16:20:56',NULL,'主机状态','HostStatus',NULL);
...
-- Dump completed on 2026-03-10 15:43:02
