...
// @Param     data  body      modelSysManagement.UpdateRolePermissionReq true "请求参数"
// @Success   200   {object}  common.Response{msg=string}
// @Router    /role_permission/update [post]
func (a *RolePermissionApi) Update(c *gin.Context) {
	var req modelSysManagement.UpdateRolePermissionReq
	if err := c.ShouldBindJSON(&req); err != nil {
		common.FailWithMessage(err.Error(), c)
		return
	}

	if err := a.rolePermissionService.Update(&req); err != nil {
		common.FailWithMessage(err.Error(), c)
