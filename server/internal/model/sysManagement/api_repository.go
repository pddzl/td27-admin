...
func (e *apiEntity) Create(ctx context.Context, req *ApiModel) (*ApiModel, error) {
...
func (e *apiEntity) GetElTree(ctx context.Context) ([]*ApiTree, error) {
	db := e.conn.WithContext(ctx)
...
func (e *apiEntity) Update(ctx context.Context, req *ApiModel) (*ApiModel, error) {
	db := e.conn.WithContext(ctx)
